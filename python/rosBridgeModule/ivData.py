...
class IvData(object):
    ...
    def is_pi(self, fun, iface):
        '''Checks if an interface is Provided'''
        return (self.iv.functions[fun.lower()]['interfaces'][iface]['direction'] == self.iv.PI)


    def is_ri(self, fun, iface):
        '''Checks if an interface is Required'''
        return (self.iv.functions[fun.lower()]['interfaces'][iface]['direction'] == self.iv.RI)
